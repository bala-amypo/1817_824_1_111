...
public class RoomAssignmentServiceImpl implements RoomAssignmentService {
    ...
    @Override
    public RoomAssignmentRecord assignRoom(Long studentAId, Long studentBId, String roomNumber) {
        RoomAssignmentRecord record = new RoomAssignmentRecord();
        record.setStudentAId(studentAId);
        record.setStudentBId(studentBId);
    ...
    public RoomAssignmentRecord updateStatus(Long id, String status) {
        ...
        record.setStatus(RoomAssignmentRecord.Status.valueOf(status.toUpperCase()));
        return roomRepo.save(record);
    }
}
